<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="NewCompany.aspx.cs" Inherits="Dbord.View.Admin.NewCompany" %>
...
<br />
<div class="card">
    <div class="card-header alert alert-danger">Add new Company</div>
    <div class="card-body">
        <div class="row">
            <div class="col-sm-6">
    ...
    SetFocusOnError="true" />
            ...
            <div class="col-sm-6">
                <asp:Button ID="btnSubmitcmpny" runat="server"
                    CssClass="btn btn-success" Text="Save" OnClick="btnSubmitcmpny_Click" ValidationGroup="company" />
...
<div class="card mt-3">
    <div class="card-header alert alert-success">Company List</div>
    <div class="card-body">
        <asp:ScriptManager 
ID="ScriptManager1" 
runat="server" />
        <asp:UpdatePanel ID="upGridcmpny" runat="server">
            <ContentTemplate>

                <asp:GridView ID="gvcatecmpny" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="S.No">
                            <ItemTemplate>
                                <%# Container.DataItemIndex + 1 + (gvcatecmpny.PageIndex * gvcatecmpny.PageSize) %>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Company Name">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtcmpny" runat="server"
