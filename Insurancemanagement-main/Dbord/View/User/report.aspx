...
<div class="card-body">
    ...
    CssClass="form-control" AutoPostBack="true" OnTextChanged="SearchTextChanged" onchange="clearEndDates()" /></td>
        <td></td>
           <td></td>
        <td></td>
            <td style="visibility:hidden"><asp:TextBox ID="txtSearchEndDateFrom" runat="server"  ClientIDMode="Static" TextMode="Date" onchange="clearStartDates()" 
        CssClass="form-control" AutoPostBack="true" OnTextChanged="SearchTextChanged" /></td>
         <td></td>
            <td style="visibility:hidden"><asp:TextBox ID="txtSearchEndDateTo" runat="server"  ClientIDMode="Static" TextMode="Date"   onchange="clearStartDates()"
    CssClass="form-control" AutoPostBack="true" OnTextChanged="SearchTextChanged" /></td>
        </tr>
    </table>
        <br />
